...
const storyData = {
  ...
  nodes: {
    ...
    next_day: {
      ...
      background: "backgrounds/bg_classroom_board.jpg",
      sprite: { image: "sprites/sprite_lab_focus.jpg", position: "right" },
      next: "after_class",
    },
    ...
    after_class: {
      ...
      text: "你刚才一直盯着我。\n\n我讲错了？",
      background: "backgrounds/bg_classroom_board.jpg",
      sprite: { image: "sprites/sprite_serious.jpg", position: "right" },
      choices: [
        {
          text: "「没有。讲得很好。」（装作若无其事）",
          next: "neutral_start",
    ...
    lab_safe: {
      ...
      text: "……（她似乎松了一口气）\n\n多练就好。你要试试吗？我帮你看着。",
      background: "backgrounds/bg_classroom_board.jpg",
      sprite: { image: "sprites/sprite_school_smile.jpg", position: "right" },
    ...
    train_trip: {
      ...
      sprite: { image: "sprites/sprite_train_sleep2.jpg", position: "right" },
      next: "yunzhou_scene",
    },
    ...
    yunzhou_scene: {
      ...
      sprite: { image: "sprites/sprite_selfie_happy.jpg", position: "center" },
      next: "yunzhou_talk",
    },
    ...
    yunzhou_talk: {
      ...
      background: "backgrounds/bg_jiulongbi.jpg",
      sprite: { image: "sprites/sprite_restaurant_smile.jpg", position: "right" },
      choices: [
        {
          text: "「你说的对。」",
          next: "yunzhou_moment",
    ...
    yunzhou_deep: {
      ...
      background: "backgrounds/bg_jiulongbi.jpg",
      sprite: { image: "sprites/sprite_selfie_happy.jpg", position: "right" },
      next: "return_scene",
    },
    ...
    return_scene: {
      ...
      background: "backgrounds/bg_train_seat.jpg",
      sprite: { image: "sprites/sprite_train_sleep.jpg", position: "center" },
      next: "night_date",
    },
    ...
    night_date: {
      ...
      sprite: { image: "sprites/sprite_street_smile.jpg", position: "right" },
